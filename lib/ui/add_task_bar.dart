...
import 'package:note_app/controller/task_controller.dart';
...
class AddTaskPgae extends StatefulWidget {
  const AddTaskPgae({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              MyInputField(title: "Title", hint: "Enter yuor title", controller: _titleController,),
              MyInputField(title: "Note", hint: "Enter yuor note", controller: _noteController,),
                ...
                3,
                  ...
                  return GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: CircleAvatar(
                        radius: 14,
                        backgroundColor: index==0?primakyClr:index==1?pinkCrl:yellowCrl,
      ...
      actions: [
        CircleAvatar(
          backgroundImage: NetworkImage(
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZdCcPmGCLj9i-e_VoP2RNztoWLgf4I6lKInOMx7TWTA&s'),
        ),
        SizedBox(
          width: 20,
        ),
